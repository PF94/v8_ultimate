...
datablock WheeledVehicleData(WCCubeVehicle) //Portal's Weighted Companian Cube to throw around with the Gravity Gun
{
	category = "Vehicles";
	displayName = " ";
	shapeFile = "./shapes/WeightedCompanianCube.dts"; 
	emap = true;
	minMountDist = 3;
   ...
   initialExplosionProjectile = WCCubeFinalExplosionProjectile;
   initialExplosionOffset = 0;         //offset only uses a z value for now

   burnTime = 10;

   finalExplosionProjectile = WCCubeFinalExplosionProjectile;
...
datablock ExplosionData(WCCubeFinalExplosion)
{
   //explosionShape = "";
   lifeTimeMS = 150;
...
datablock ProjectileData(WCCubeFinalExplosionProjectile)
{
   directDamage        = 0;
   radiusDamage        = 0;
   damageRadius        = 0;
   explosion           = WCCubeFinalExplosion;
...
function WCCubeVehicle::onAdd(%this,%a,%b,%c)
{
	//%a.setscale("1.5 1.5 1.5");
}


function WCCubeVehicle::onRemove(%this,%a,%b,%c)
{
	//nothing
}