...
datablock ProjectileData(ForkProjectile)
{
   projectileShapeName = "./shapes/forkProjectile.dts";
   directDamage        = 50;
...
// item //
//////////
datablock ItemData(forkItem)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./shapes/fork.dts";
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	friction = 0.6;
...
//weapon image//
////////////////
datablock ShapeBaseImageData(forkImage)
{
   // Basic Item properties
   shapeFile = "./shapes/fork.dts";
   emap = true;
...
function forkImage::onCharge(%this, %obj, %slot)
{
	%obj.playthread(2, spearReady);
}

function forkImage::onAbortCharge(%this, %obj, %slot)
{
	%obj.playthread(2, root);
}

function forkImage::onFire(%this, %obj, %slot)
{
