...
datablock ExplosionData(troopshipExplosion: jeepExplosion)
{
   debrisNum = 0;
};

datablock ProjectileData(troopshipExplosionProjectile)
{
   directDamage        = 0;
   radiusDamage        = 0;
   damageRadius        = 0;
   explosion           = troopshipExplosion;
...
datablock ExplosionData(troopshipFinalExplosion)
{
     //explosionShape = "";
   lifeTimeMS = 150;
...
datablock ProjectileData(troopshipFinalExplosionProjectile)
{
   directDamage        = 0;
   radiusDamage        = 0;
   damageRadius        = 0;
   explosion           = troopshipFinalExplosion;
...
//---------------------------------------------------------------------------------------
// Drone Definition
datablock FlyingVehicleData(troopship)
{
	spawnOffset						= "0 0 2";
	emap							= true;
	category						= "Vehicles";
    shapeFile                       = "~/shapes/troopship.dts";
	multipassenger					= True;
	computeCRC						= true;
...
function troopship::onEnterLiquid(%this, %obj, %coverage, %type)
{
	cancel(%obj.floatSchedule);
}
function troopship::onLeaveLiquid(%this, %obj, %type)
{
	%obj.floatSchedule = schedule(10,0,lowerboat,%obj);
}
function troopship::onImpact(%this, %obj, %collidedObject, %vec, %vecLen)
{
	%obj.setvelocity("0 0 0");
}
function troopship::onDamage(%this, %obj, %delta)
{
...
function troopship::onAdd(%this,%obj)
{		 
