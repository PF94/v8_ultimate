...
//-----------------------------------------------------------------------------
if(!isObject(boxExplosionSound))
{
   exec("./Support_box.cs");
}
//----------------------------------------------------------------------------

datablock WheeledVehicleData(boxVehicle)
{
	category = "Vehicles";
	displayName = " ";
	shapeFile = "add-ons/shapes/box/box.dts"; //"~/data/shapes/skivehicle.dts"; //
	emap = true;
	minMountDist = 3;
   ...
   contactTol = 0.1;
	...
	defaultTire	= boxTire;
	defaultSpring	= boxSpring;
	flatTire	= boxFlatTire;
	flatSpring	= boxFlatSpring;
   ...
   numWheels = 4;
	...
	brakeTorque = 5000000;        // When brakes are applied
