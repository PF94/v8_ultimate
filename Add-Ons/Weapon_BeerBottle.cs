...
//projectile
AddDamageType("Sword",   '<bitmap:add-ons/ci/beerbottleci.png> %1',    '%2 <bitmap:add-ons/ci/beerbottleci.png> %1',1,1);
...
datablock ItemData(swordItem)
{
	...
	shapeFile = "./shapes/beerbottle.dts";
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	friction = 0.6;
