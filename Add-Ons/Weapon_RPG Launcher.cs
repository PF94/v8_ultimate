...
AddDamageType("rpgDirect",   '<bitmap:add-ons/ci/ocket> %1',    '%2 <bitmap:add-ons/ci/rocket> %1',1,1);
AddDamageType("rpgRadius",   '<bitmap:add-ons/ci/rocketRadius> %1',    '%2 <bitmap:add-ons/ci/rocketRadius> %1',1,0);
datablock ProjectileData(rpgLauncherProjectile)
{
...
datablock ShapeBaseImageData(rpgLauncherImage)
{
   ...
   item = BowItem;
   ammo = " ";
   projectile = rpgLauncherProjectile;
